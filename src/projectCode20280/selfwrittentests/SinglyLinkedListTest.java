...
public class SinglyLinkedListTest {
    ...
    void testAdd() {
        try {
            ...
            Assertions.fail("Illegal index for adding operation");
    ...
    void testRemoveFirst() {
        try {
            list.removeFirst();
            Assertions.fail("Cannot remove from empty list");
    ...
    void testRemove() {
        ...
        try {
            list.remove(-1);
            Assertions.fail("Cannot remove from illegal index");
        } catch (IndexOutOfBoundsException ex) {
            // do nothing
        }
    ...
    void testGet() {
        try {
            list.get(0);
            Assertions.fail("Cannot get from illegal index");
        } catch (IndexOutOfBoundsException ex) {
            // do nothing
        }
        list.addFirst("A");
