...
class TreeMapTest {
    ...
    void testPut() {
        ...
        Integer[] sorted = {1, 2, 4, 5, 12, 15, 21, 23, 24, 26, 33, 35};
        int i = 0;
        for (int keyEntry : map.keySet()) {
            assertEquals(sorted[i++], keyEntry);
        }
    }
    ...
    void testToString() {
        ...
        assertEquals("[<1, 1>, <2, 2>, <4, 4>, <5, 5>, <12, 12>, " +
                "<15, 15>, <21, 21>, <23, 23>, <24, 24>, <26, 26>, " +
                "<33, 33>, <35, 35>]", map.toString());
    }
